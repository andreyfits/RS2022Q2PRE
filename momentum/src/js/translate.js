...
export default () => {
    ...
    function setLang(lang) {
        ...
        const enSettings = ['Language', ' Audioplayer', 'Weather', 'Time', 'Date', 'Greeting', 'Quotes', 'Visualizer', 'Photosource'];
        const ruSettings = ['Язык', ' Аудиоплеер', 'Погода', 'Время', 'Дата', 'Приветствие', 'Цитаты', 'Визуализатор', 'Фоторесурс'];
        let titles;
